        ...
        <div className='grid grid-cols-1 md:grid-cols-12'>
            ...
            className='col-span-8 place-self-center text-left justify-self-start'>
                ...
                <p className='text-mycolor-100 text-base mb-6 lg:text-lg'>
                    Lorem ipsum dolor sit amet consectetur adipisicing elit. Odit aspernatur ex praesentium. Dicta, blanditiis, accusamus eum sed voluptatum culpa nulla, iste enim natus repudiandae molestiae!
                </p>
                <div>
                    <Link href="/#contact" className='px-6 inline-block py-3 w-full md:w-fit rounded-full bg-gradient-to-br from-mycolor-200 to-mycolor-100 text-white text-center mr-4'>
                        Hire
